...
func (t *DarwinTracker) Deps() string {
	return `
No external dependencies are required, but you do need to enable privileges for "System Events" in System Preferences > Security & Privacy > Privacy > Accessibility.
